...
def main() -> None:  # noqa: C901, PLR0915
    ...
    tf_parser = subparsers.add_parser("idf", help="Get inverse document frequency for a given term")
    tf_parser.add_argument("term", type=str, help="Term to get IDF for")
